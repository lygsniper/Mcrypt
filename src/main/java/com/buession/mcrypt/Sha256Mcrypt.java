...
public final class Sha256Mcrypt extends Mcrypt {
	 ...
	 *        信息摘要对象的提供者
	 */
	public Sha256Mcrypt(int count, Provider provider) {
	 ...
	 *        信息摘要对象的提供者
	 */
	public Sha256Mcrypt(final String characterEncoding, Provider provider) {
	 ...
	 *        重复加密次数
	 */
	public Sha256Mcrypt(final String characterEncoding, int count) {
	 ...
	 *        信息摘要对象的提供者
	 */
	public Sha256Mcrypt(final String characterEncoding, int count, Provider provider) {
	 ...
	 *        信息摘要对象的提供者
	 */
	public Sha256Mcrypt(final String characterEncoding, final String salt, Provider provider) {
	 ...
	 *        重复加密次数
	 */
	public Sha256Mcrypt(final String characterEncoding, final String salt, int count) {
